...
class PerceptronModel(object):
    ...
    def train(self, dataset):
        ...
        """
        # This should repeatedly loop over the data set and make updates on examples that are misclassified. Use the
        # update method of the nn.Parameter class to update the weights. When an entire pass over the data set is
        # completed without making any mistakes, 100% training accuracy has been achieved, and training can terminate.
...
class RegressionModel(object):
    ...
    def __init__(self):
        ...
        self.w1 = nn.Parameter(1, 512)  # Weight for the first layer
        self.b1 = nn.Parameter(1, 512)  # Bias for the first layer
        self.w2 = nn.Parameter(512, 1)  # Weight for the second layer
    ...
    def train(self, dataset):
        ...
        """
        learning_rate = 0.05
        # Stop when the loss is less than 0.02
